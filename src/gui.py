...
labelFont = QFont('Helvetica', 14, QFont.Bold)
labelFont2 = QFont('Helvetica', 12, QFont.Bold)
labelFont3 = QFont('Helvetica', 10)
...
class FlashWindow(QWidget):
    def __init__(self, file_path, parent=None):
        ...
        self.load_label.setFont(labelFont2)
